...
public class Materialhistory implements Serializable {
    ...
    @NotNull
    private Transferclassification transferclassification2;
    ...
    public Transferclassification getTransferclassification2() {
        return transferclassification2;
    }

    public Materialhistory transferclassification2(Transferclassification transferclassification) {
        this.transferclassification2 = transferclassification;
        return this;
    }

    public void setTransferclassification2(Transferclassification transferclassification) {
        this.transferclassification2 = transferclassification;
    }
