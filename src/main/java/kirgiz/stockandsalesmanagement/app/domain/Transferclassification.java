...
public class Transferclassification implements Serializable {
    ...
    @OneToMany(mappedBy = "transferclassification2")
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    ...
    public Transferclassification materialhistory1S(Set<Materialhistory> materialhistories) {
        this.materialhistory1S = materialhistories;
        return this;
    }

    public Transferclassification addMaterialhistory1(Materialhistory materialhistory) {
        this.materialhistory1S.add(materialhistory);
        materialhistory.setTransferclassification2(this);
        return this;
    }

    public Transferclassification removeMaterialhistory1(Materialhistory materialhistory) {
        this.materialhistory1S.remove(materialhistory);
        materialhistory.setTransferclassification2(null);
        return this;
    }
