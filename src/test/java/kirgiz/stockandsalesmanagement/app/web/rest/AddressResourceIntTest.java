...
public class AddressResourceIntTest {
    ...
    public static Address createEntity(EntityManager em) {
        ...
        // Add required entity
        Addressclassification addressclassification8 = AddressclassificationResourceIntTest.createEntity(em);
        em.persist(addressclassification8);
        em.flush();
        address.setAddressclassification8(addressclassification8);
        return address;
    }
