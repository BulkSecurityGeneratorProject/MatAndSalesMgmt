...
public class MaterialhistoryResourceIntTest {
    ...
    public static Materialhistory createEntity(EntityManager em) {
        ...
        // Add required entity
        Transferclassification transferclassification2 = TransferclassificationResourceIntTest.createEntity(em);
        em.persist(transferclassification2);
        em.flush();
        materialhistory.setTransferclassification2(transferclassification2);
        // Add required entity
