...
public class ThirdResourceIntTest {
    ...
    public static Third createEntity(EntityManager em) {
        ...
        // Add required entity
        Thirdclassification thirdClassification9 = ThirdclassificationResourceIntTest.createEntity(em);
        em.persist(thirdClassification9);
        em.flush();
        third.setThirdClassification9(thirdClassification9);
        // Add required entity
        Civility civility1 = CivilityResourceIntTest.createEntity(em);
        em.persist(civility1);
        em.flush();
        third.setCivility1(civility1);
        return third;
    }
