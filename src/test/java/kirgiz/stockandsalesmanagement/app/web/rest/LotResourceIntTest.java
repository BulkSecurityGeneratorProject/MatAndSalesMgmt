...
public class LotResourceIntTest {
    ...
    public static Lot createEntity(EntityManager em) {
        ...
        // Add required entity
        Currency buycurrency1 = CurrencyResourceIntTest.createEntity(em);
        em.persist(buycurrency1);
        em.flush();
        lot.setBuycurrency1(buycurrency1);
        // Add required entity
        Currency sellcurrency1 = CurrencyResourceIntTest.createEntity(em);
        em.persist(sellcurrency1);
        em.flush();
        lot.setSellcurrency1(sellcurrency1);
        return lot;
    }
